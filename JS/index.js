...
(function run() {
    ...
    let militaryAirport = new Airport(airport.getPlanesOfAppropriateType(MilitaryPlane));
    let passengerAirport = new Airport(airport.getPlanesOfAppropriateType(PassengerPlane));
